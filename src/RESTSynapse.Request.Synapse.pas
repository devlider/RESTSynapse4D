unit RESTSynapse.Request.Synapse;
...
uses Classes, SysUtils, DB, RESTSynapse.Request.Contract, RESTSynapse.Response.Contract, RESTSynapse.Utils,
  httpsend, ssl_openssl, Generics.Collections, RESTSynapse.Request.Adapter.Contract,
  {$IFDEF FPC}
...
uses RESTSynapse.Response.Synapse;
